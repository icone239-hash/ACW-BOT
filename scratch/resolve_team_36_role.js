...
client.once('ready', async () => {
  ...
  const r1 = guild.roles.cache.get('1531444573107388469');
  const r2 = guild.roles.cache.get('1531445225174863943');

  console.log('Role 1531444573107388469:', r1 ? r1.name : 'NOT FOUND');
  console.log('Role 1531445225174863943:', r2 ? r2.name : 'NOT FOUND');
